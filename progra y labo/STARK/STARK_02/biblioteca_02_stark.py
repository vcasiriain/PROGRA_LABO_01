...
def mostrar_menu() -> str: 
    menu =\
    """    
    1. Mostrar los nombres de cada superheroe
    2. Mostrar los nombres de cada superheroe junto a su altura
    3. Mostrar al superheroe mas alto
    4. Mostrar al superheroe mas bajo
    5. Mostrar la identidad del superheroe mas alto y mas bajo
    6. Mostrar el superheroe mas pesado y el menos pesado
    0. Salir
    """
    print(menu)
